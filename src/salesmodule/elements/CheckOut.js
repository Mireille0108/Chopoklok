...
const CheckOut = () => {
  return (
    <section class="h-screen bg-gray-100 py-3 sm:py-4 lg:py-5">
        ...
        <div class="px-4 py-6 sm:px-8 sm:py-10">
          <div class="flow-root">
            <ul class="-my-8">
              <li class="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                <div class="shrink-0">image
                  <img class="h-24 w-24 max-w-full rounded-lg object-cover"  src='./src\assets\Images\achu.jpg' alt="" />
                </div>

                <div class="relative flex flex-1 flex-col justify-between">
                  <div class="sm:col-gap-5 sm:grid sm:grid-cols-2">
                    <div class="pr-8 sm:pr-5">
                      <p class="text-base font-semibold text-gray-900">Achu1</p>
                      <p class="mx-0 mt-1 mb-0 text-sm text-gray-400">2500FCFA</p>
                    </div>

                    <div class="mt-4 flex items-end justify-between sm:mt-0 sm:items-start sm:justify-end">
                      <p class="shrink-0 w-20 text-base font-semibold text-gray-900 sm:order-2 sm:ml-8 sm:text-right">2500.00FCFA</p>
              ...
              <li class="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                <div class="shrink-0">
                  <img class="h-24 w-24 max-w-full rounded-lg object-cover" src="./src\assets\Images\achu.jpg" alt="Achu1" />
                </div>

                <div class="relative flex flex-1 flex-col justify-between">
                  <div class="sm:col-gap-5 sm:grid sm:grid-cols-2">
                    <div class="pr-8 sm:pr-5">
                      <p class="text-base font-semibold text-gray-900">Achu</p>
                      <p class="mx-0 mt-1 mb-0 text-sm text-gray-400">2500frs - 3500frs</p>
                    </div>
          ...
          <div class="mt-6 border-t border-b py-2">
            <div class="flex items-center justify-between">
              ...
              <p class="text-lg font-semibold text-gray-900">2500.00FCFA</p>
            </div>
            <div class="flex items-center justify-between">
              <p class="text-sm text-gray-400">Shipping</p>
              <p class="text-lg font-semibold text-gray-900">500.00FCFA</p>
            </div>
            <div class="flex items-center justify-between">
          ...
          <div class="mt-6 flex items-center justify-between">
            ...
            <p class="text-2xl font-semibold text-gray-900"><span class="text-xs font-normal text-gray-400">FCFA</span> 3000.00</p>
          </div>
